...
public interface BoardMapper {
	...
	String selectLoginCheck(BoardVO searchVO);		/* newly made in sql  그래서, 여기에 등록한다. */
	
	void insertReply(BoardVO vo) throws Exception;
	
	List<?> selectReplyList(BoardVO searchVO) throws Exception;
	void updateBoardViewCount(BoardVO vo) throws Exception;	     
		
	String insertAttach(BoardVO vo) throws Exception;
